...
public class TelaVencedor extends JFrame implements ActionListener{
    ...
    Font fonteTitle = new Font("Comic sans", Font.BOLD, 50);
    Font fonteTexto = new Font("Comic sans", Font.PLAIN, 30);
    ...
    public void play(Point localTela, int ganhador, String jogador, String modo) {
        ...
        texto.setText("<html><center>Vitória do jogador "+ganhador+"<br><center>(simbolo: \""+jogador+"\")</html>");
